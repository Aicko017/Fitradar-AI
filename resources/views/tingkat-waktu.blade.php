<x-app-layout>
    <div class="min-h-screen bg-[#1E1F9D] flex flex-col justify-center items-center px-4">
        ...
        <form method="POST" action="{{ route('simpan-waktu-olahraga') }}" class="bg-white rounded-3xl p-6 sm:p-8 w-full max-w-xl text-center">
            @csrf
            ...
            <div class="flex justify-between mt-8">
                <a href="{{ route('halaman-sebelumnya') }}" class="bg-white border border-black text-black font-medium px-6 py-2 rounded-full hover:bg-gray-100">
                    Sebelumnya
                </a>
                <a href="{{ route('halaman-preferensi-makan') }}" 
   class="bg-white border border-black text-black font-medium px-6 py-2 rounded-full hover:bg-gray-100">
   Selanjutnya
</a>
