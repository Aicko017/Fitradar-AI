    ...
    <div class="min-h-screen" style="background-color: #1E1F9D;">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 py-8">
            <div class="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div class="mb-6">
                    <h2 class="text-xl font-semibold mb-4 text-center" style="color: #1E1F9D;">Bagaimana tingkat aktivitas fisikmu sekarang?</h2>
                    ...
                    <form action="/halaman5" method="GET" class="space-y-3">
                        ...
                        <label class="block border border-gray-300 rounded-md p-4 hover:bg-gray-100 cursor-pointer">
                            <div class="flex items-center">
                                <input type="radio" name="tingkat_aktivitas" value="menengah" class="form-radio" style="color: #1E1F9D; -webkit-appearance: none; appearance: none; width: 16px; height: 16px; border: 1px solid #ccc; border-radius: 50%; outline: none; cursor: pointer; display: inline-block; vertical-align: middle; margin-right: 0.5rem; background-color: white; background-clip: content-box; padding: 2px; transition: background-color 0.2s;">
                                <div class="ml-4">
                                    <span class="font-semibold text-gray-700 block">Menengah</span>
                                    <p class="text-gray-500 text-sm block">(Saya sudah berolahraga beberapa waktu dan merasa percaya diri dengan sebagian besar latihan)</p>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="block border border-gray-300 rounded-md p-4 hover:bg-gray-100 cursor-pointer">
                            <div class="flex items-center">
                                <input type="radio" name="tingkat_aktivitas" value="berpengalaman" class="form-radio" style="color: #1E1F9D; -webkit-appearance: none; appearance: none; width: 16px; height: 16px; border: 1px solid #ccc; border-radius: 50%; outline: none; cursor: pointer; display: inline-block; vertical-align: middle; margin-right: 0.5rem; background-color: white; background-clip: content-box; padding: 2px; transition: background-color 0.2s;">
                                <div class="ml-4">
                                    <span class="font-semibold text-gray-700 block">Berpengalaman</span>
                                    <p class="text-gray-500 text-sm block">(Saya sudah lama berolahraga dan ingin sesuatu yang menantang)</p>
                                </div>
                            </div>
                        </label>

                        <a href="{{ route('tingkat-waktu') }}" class="bg-[#1E1F9D] text-white px-10 py-3 rounded-full hover:bg-[#15168a] focus:outline-none focus:ring-2 focus:ring-[#1E1F9D] focus:ring-offset-2 transition-all duration-200 font-bold">
                            Selanjutnya
                        </a>
                    </form>
                </div>
